...
answer_prompt = ChatPromptTemplate.from_messages([
    (
        "system",
        "You are an assistant that helps users with their questions. Generate the best response possible in the shortest way, combining learned information when relevant."
    ),
